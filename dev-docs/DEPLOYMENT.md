...
2. **Model Studio / DashScope API key** — https://dashscope.console.aliyun.com/
3. **Container Registry (ACR) namespace** — https://cr.console.aliyun.com/ (personal edition is free)
